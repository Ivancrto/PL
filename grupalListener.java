...
public interface grupalListener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by {@link grupalParser#r}.
	 * @param ctx the parse tree
	 */
	void enterR(grupalParser.RContext ctx);
	/**
	 * Exit a parse tree produced by {@link grupalParser#r}.
	 * @param ctx the parse tree
	 */
	void exitR(grupalParser.RContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link grupalParser#comment}.
	 * @param ctx the parse tree
	 */
	void enterComment(grupalParser.CommentContext ctx);
	/**
	 * Exit a parse tree produced by {@link grupalParser#comment}.
	 * @param ctx the parse tree
	 */
	void exitComment(grupalParser.CommentContext ctx);
}